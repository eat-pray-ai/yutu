...
var listInSchema = &jsonschema.Schema{
	Type: "object",
	Required: []string{
		"ids", "channelId", "hl", "mine", "onBehalfOfContentOwner",
...
func init() {
	mcp.AddTool(
		cmd.Server, &mcp.Tool{
			Name: "channelSection-list", Title: listShort, Description: listLong,
...
func listHandler(
	...
	if err != nil {
		slog.ErrorContext(
			ctx, "channelSection list failed", "error", err, "input", input,
		)
		return nil, nil, err
	}
	slog.InfoContext(
