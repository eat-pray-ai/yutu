...
const (
	...
	localeUsage     = "Locale of the video metadata to return"
	...
	mhUsage         = "Max height of the embedded player in pixels"
	mwUsage         = "Max width of the embedded player in pixels"
