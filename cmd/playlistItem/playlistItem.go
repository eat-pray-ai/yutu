...
const (
	short        = "Manage YouTube playlist items"
	long         = "Manage YouTube playlist items. Use this tool to list items in a playlist, add new items, update items, or remove items."
