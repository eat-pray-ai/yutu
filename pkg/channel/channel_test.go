	...
	}{
		{
			...
			args: args{
				opts: []Option{
					...
					WithDefaultLanguage(new("en")),
					WithDescription(new("Test channel description")),
	...
	tests := []struct {
	...
	}{
		{
			...
			opts: []Option{
				...
				WithTitle("New Title"),
				WithDescription(new("New Description")),
				WithMaxResults(1),
			},
			verify: func(r *http.Request) {
				switch r.Method {
